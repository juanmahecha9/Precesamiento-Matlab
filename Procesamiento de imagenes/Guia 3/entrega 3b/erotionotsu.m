...
subplot(1,2,2),imshow(I),title('Binarizacion Otsu')
figure,
subplot(1,2,1),imshow(Ier),title('Erosion Otsu')
subplot(1,2,2),imshow(E1),title('Erosion por funcion de matlab')
figure,
subplot(1,2,1),imshow(I1),title('Imagen Original en gris')
subplot(1,2,2),imshow(D),title('Multiplicacion punto a punto Otsu')
